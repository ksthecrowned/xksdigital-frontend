...
const NavItemMegamenu: React.FC = () => {
    ...
    return (
        ...
        >
            <button type="button" className="flex items-center w-full font-medium text-gray-400 hover:text-gray-500">
                Resources
            ...
            {
                dropdownOpen && (
                    <div className="absolute w-full hidden md:block z-10 top-20 left-0 min-w-[15rem] bg-white md:shadow-2xl rounded-lg py-2 md:p-8 dark:bg-gray-800 dark:divide-gray-700 before:absolute before:-top-5 before:left-0 before:w-full before:h-5 bounce-short">
                        <div className="md:grid md:grid-cols-2 lg:grid-cols-3 gap-4">
                            <div className="flex flex-col mx-1 md:mx-0">
                                <a className="group flex gap-x-5 text-gray-800 hover:bg-gray-100 rounded-md p-4 dark:text-gray-200 dark:hover:bg-gray-900" href="#">
                                    ...
                                    <div className="grow">
                                        ...
                                        <p className="text-sm text-gray-500 group-hover:text-gray-800 dark:group-hover:text-gray-200">Explore advice and explanations for all of Preline features.</p>
                                    </div>
                                </a>
                                ...
                                <a className="group flex gap-x-5 text-gray-800 hover:bg-gray-100 rounded-md p-4 dark:text-gray-200 dark:hover:bg-gray-900" href="#">
                                    ...
                                    <div className="grow">
                                        ...
                                        <p className="text-sm text-gray-500 group-hover:text-gray-800 dark:group-hover:text-gray-200">Build custom integrations with our first-className API.</p>
                                    </div>
                                </a>
                            </div>
