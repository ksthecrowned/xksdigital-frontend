    ...
    return (
        <section className="bg-gray-50 dark:bg-gray-900 pb-8">
            <div className="max-w-[85rem] px-4 sm:px-6 lg:px-8 mx-auto">
                <div className="md:grid md:grid-cols-2 md:items-center md:gap-12 gap-20">
                        ...
                        <div className="space-y-6 sm:space-y-8">
                            ...
                            <ul role="list" className="space-y-2 sm:space-y-4">
                                <li className="flex space-x-3 items-center">
                                    <svg className="flex-shrink-0 h-8 w-8 text-red-600 dark:text-red-500" width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
